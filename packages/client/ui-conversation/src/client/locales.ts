...
export const zh = {
  ...
  'report.searchPlaceholder': '在报告中搜索…',
  'report.searchPrev': '上一个',
  'report.searchNext': '下一个',
  'report.searchClear': '清除',
  'report.minimizePanel': '最小化',
  'report.expandPanel': '展开面板',
  'report.closeAll': '全部关闭',
  'report.askPlaceholder': '就这份报告提问…',
  'report.askInChat': '在对话中提问',
...
export const en = {
  ...
  'report.searchPlaceholder': 'Search in report…',
  'report.searchPrev': 'Previous',
  'report.searchNext': 'Next',
  'report.searchClear': 'Clear',
  'report.minimizePanel': 'Minimize',
  'report.expandPanel': 'Expand panel',
  'report.closeAll': 'Close all',
  'report.askPlaceholder': 'Ask about this report…',
  'report.askInChat': 'Ask in chat',
